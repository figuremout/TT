...
import com.example.tt.ProfileActivity;
...
public class myHttp {
    ...
    public static String getHTTPReq(String router) throws IOException {
...
//            System.out.println(lines);
    ...
    public static String postHTTPReq(String router, String content) throws IOException {
